                    ...
                    @foreach($subjects as $key => $subject)
                        <tr data-entry-id="{{ $subject->id }}">
                            ...
                            <td>
                                    ...
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.roles.show', $subject->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                               

                               
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.roles.edit', $subject->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                
                                    <form action="{{ route('admin.roles.destroy', $subject->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
