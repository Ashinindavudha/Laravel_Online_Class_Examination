...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-striped table-hover datatable datatable-Permission {{ count($results) > 0 ? 'datatable' : '' }}">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        @endif
                        <th>
                            {{ trans('cruds.result.fields.date') }}
                        </th>
                        <th>
                            {{ trans('cruds.result.fields.exam_result') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
